	...
	public DriverInstance(String Application) {
		...
		try {
			...
			case "Android":
				...
				Utilities.diff = (EndTime-StartTime);
				logger.info("App launch time : "+Utilities.diff);
				break;
...
//		capabilities.setCapability("compressXml", "true");
		...
		capabilities.setCapability(MobileCapabilityType.UDID, “4f9e8c63”);
		...
		//capabilities.setCapability(MobileCapabilityType.APP, "cloud:com.graymatrix.did/com.applicaster.componentsapp.IntroActivity");
